...
#   Character.create(name: 'Luke', movie: movies.first)
    ...
    Post.create(title: 'Rain', content: 'Its always rainy here!', user_id: '2', city: 'Seattle')
    ...
    Post.create(title: 'Stuffy', content: 'Its always hot here!', user_id: '1', city: 'Topeka')
    ...
    Post.create(title: 'Cat', content: 'I adopted my cat here!', user_id: '4', city: 'Manhattan')
